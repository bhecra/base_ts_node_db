...
dbConnection.connectToDataBase()
    .then(_ => {
        console.log('\x1b[33m%s\x1b[0m: Database correctly \x1b[32m%s\x1b[0m', `[db-${dbReference}]`, 'connected');
        app.listen(PORT, () => {
          console.log(`🚀 Server started on \x1b[34m%s\x1b[0m `,`http://localhost:${PORT}`);
        });
    })
    .catch((error: any) => {
